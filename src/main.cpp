...
int main(int argc, char* argv[])
{
    ...
    core::PatternPlayer pattern_player { project_repository, apu_emulator,
                                         note_player };
    ...
    use_cases::ProjectUseCases project_use_cases {
        project_repository, events_processor, note_player,
        pattern_player,     song_player,      std::move(export_services)
    };
