...
SongView::SongView(use_cases::ProjectUseCases& use_cases, size_t song_index)
{
    ...
    ImGui::BeginChild(
        "SongView", ImVec2 { -1, cellHeight * 4 + 4 }, 0,
    ...
    ImGui::BeginChild(
        "Pulse 1 Label", ImVec2 { 64, cellHeight }, ImGuiChildFlags_Borders,
        ImGuiWindowFlags_NoScrollbar);
    {
        ...
        draw_helper.drawFilledRect(
            { 0, 0 }, { 64, cellHeight },
            getClickableItemColor(GuiState::trackIndex() == 0));
    ...
    ImGui::BeginChild(
        "Pulse 2 Label", ImVec2 { 64, cellHeight }, ImGuiChildFlags_Borders,
        ImGuiWindowFlags_NoScrollbar);
    {
        WindowDrawHelper draw_helper;
        ImGui::Dummy({ 64, cellHeight });
        draw_helper.drawFilledRect(
            { 0, 0 }, { 64, cellHeight },
            getClickableItemColor(GuiState::trackIndex() == 1));
    ...
    ImGui::BeginChild(
        "Wave Label", ImVec2 { 64, cellHeight }, ImGuiChildFlags_Borders,
        ImGuiWindowFlags_NoScrollbar);
    {
        WindowDrawHelper draw_helper;
        ImGui::Dummy({ 64, cellHeight });
        draw_helper.drawFilledRect(
            { 0, 0 }, { 64, cellHeight },
            getClickableItemColor(GuiState::trackIndex() == 2));
    ...
    ImGui::BeginChild(
        "Noise Label", ImVec2 { 64, cellHeight }, ImGuiChildFlags_Borders,
        ImGuiWindowFlags_NoScrollbar);
    {
        WindowDrawHelper draw_helper;
        ImGui::Dummy({ 64, cellHeight });
        draw_helper.drawFilledRect(
            { 0, 0 }, { 64, cellHeight },
            getClickableItemColor(GuiState::trackIndex() == 3));
    ...
    ImGui::BeginChild(
        "Patterns", ImVec2 { 64, cellHeight }, ImGuiChildFlags_Borders,
        ImGuiWindowFlags_NoScrollbar);
    {
        WindowDrawHelper draw_helper;
    ...
    {
        ImGui::SameLine();
        PatternView pattern_view { use_cases, pattern_index };
    }
}
